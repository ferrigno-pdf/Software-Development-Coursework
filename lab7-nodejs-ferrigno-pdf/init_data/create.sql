...
insert into reviews (username, review, rating) values ('fakramf', 'Sedte.', 2.55);
insert into reviews (username, review, rating) values ('fakramf', 'ssss.', 3.55);
insert into reviews (username, review, rating) values ('fakramf', 'ffff.', 4.55);
insert into reviews (username, review, rating) values ('fakramf', 'xxxxx.', 2.55);
